 ...
 * @param reply The reply function to respond to the requester
 */
 ...
 * @param operationDescriptor The operation descriptor associated to the received request
 ...
 * @param request The received request
 * @param err The error which caused the processing of the request to be cancelled
 */
 ...
 * @param request The received updateContext request
 * @param err Error, if any, when sending the request to the third party
 * @param response The response, if any, received from the third party
 */
 ...
 * @param request The updateContext request received
 * @param serviceDescriptor The service descriptor associated to the received request
 */
