...
function processOperationRequest(request, serviceDescriptor) {
  ...
  switch (request.contextAdapter.operationDescriptor.interactionType) {
    case caConfig.BUTTON_ENTITY.OPERATION_INTERACTION_TYPE.SYNCHRONOUS:
      ...
      break;
    case caConfig.BUTTON_ENTITY.OPERATION_INTERACTION_TYPE.ASYNCHRONOUS:
