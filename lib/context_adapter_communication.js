...
function getButtonInteractionType(thirdPartyUpdateRequest, callback) {
  ...
  caLogger.debug(
    ...
    thirdPartyUpdateRequest.payload.buttonId + '\' using payload: ' +
 ...
 */
function notifyOperationCompleted(request, thirdPartyUpdateRequest, callback) {
  var contextElements = [
    {
   ...
   */
  function setSynchronousButtonAttributes() {
  ...
  function doSendUpdateContext() {
    ...
    caLogger.debug(
      request ? request.contextAdapter.context : thirdPartyUpdateRequest.contextAdapter.context,
      'Notifying the Context Broker that the request has been completed with headers ' +
      'Fiware-Service: ' + (request ? request.headers['fiware-service'] :
        thirdPartyUpdateRequest.headers['fiware-service']) + ' and ' +
      'Fiware-ServicePath: ' + (request ? request.headers['fiware-servicepath'] :
        thirdPartyUpdateRequest.headers['fiware-servicepath']) +
      ' and payload: ' + JSON.stringify(payload)
    );

    sendUpdateContext(
      request ? request.headers['fiware-service'] : thirdPartyUpdateRequest.headers['fiware-service'],
      request ? request.headers['fiware-servicepath'] : thirdPartyUpdateRequest.headers['fiware-servicepath'],
      payload,
      callback
    );
  }
  ...
  if (request) {
    ...
    // Asynchronous Third Party request
