...
module.exports = {
  ...
  /**
   * BadOperationStatus error type
   * @param {String} operationStatus The operation status
   * @constructor
   */
  BadOperationStatus: function(buttonId, operationStatus) {
    this.code = 'BAD_OPERATION_STATUS';
    this.message = 'The button with id "' + buttonId + '" has \'' +
