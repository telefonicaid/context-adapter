...
function notifyOperationCompleted(request, data, callback) {
  ...
  caLogger.info(
    ...
    'Fiware-Service: ' + (request ? request.headers['fiware-service'] : data.headers['fiware-service']) +
    'Fiware-ServicePath: ' + (request ? request.headers['fiware-servicepath'] : data.headers['fiware-service']) +
    ' and payload: ' + JSON.stringify(payload)
  );
