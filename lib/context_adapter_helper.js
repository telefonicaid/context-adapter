...
function notifyOperationCompleted(request, data, callback) {
  ...
  sendUpdateContext(
    request ? request.headers['fiware-service'] : 'blackday16',// data.headers['fiware-service'],
    request ? request.headers['fiware-servicepath'] : '/testpizza', // data.headers['fiware-service'],
    payload,
    callback
  );
}
