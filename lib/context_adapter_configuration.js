 ...
 * CA_OPERATION_ACTION_ATTR_NAME: string, CA_OPERATION_INTERACTION_TYPE_ATTR_NAME: string,
 * OPERATION_INTERACTION_TYPE: {SYNCHRONOUS: string, ASYNCHRONOUS: string}, CA_OPERATION_EXTRA_ATTR_NAME: string,
 ...
 * OPERATION_TYPE: {NOT_AVAILABLE: string, STARTUP: string, SHUTDOWN: string, SERVER_START: string, SERVER_LOG: string,
 * SERVER_STOP: string}}}
 */
module.exports = {
  ATTRIBUTE_TYPE: {
  ...
  BUTTON_ENTITY: {
    ...
    CA_OPERATION_INTERACTION_TYPE_ATTR_NAME: 'aux_interaction_type',
    OPERATION_INTERACTION_TYPE: {
