 ...
 * CA_OPERATION_ACTION_ATTR_NAME: string, OPERATION_ACTION: {SYNCHRONOUS: string, ASYNCHRONOUS_CREATE: string},
 * CA_OPERATION_EXTRA_ATTR_NAME: string, OPERATION_STATUS_ATTR_NAME: string, IOTA_OPERATION_STATUS_ATTR_NAME: string,
 * CA_OPERATION_STATUS_ATTR_NAME: string, OPERATION_STATUS: {IN_PROGRESS: string, CLOSED: string, COMPLETED: string},
 * OPERATION_RESULT_ATTR_NAME: string, IOTA_OPERATION_RESULT_ATTR_NAME: string, CA_OPERATION_RESULT_ATTR_NAME: string},
 * SERVICE_ENTITY: {TYPE: string, ENDPOINT_ATTR_NAME: string, METHOD_ATTR_NAME: string,
 * AUTHENTICATION_ATTR_NAME: string, MAPPING_ATTR_NAME: string, TIMEOUT_ATTR_NAME: string},
 * UPDATE_WEB_HOOK_PATH: string, UNICA_CORRELATOR_HEADER: string, UNICA_CORRELATOR: {NOT_AVAILABLE: string},
 * OPERATION_TYPE_PREFIX: string, TRANSACTION_ID: {NOT_AVAILABLE: string}, OPERATION_TYPE: {NOT_AVAILABLE: string,
 * STARTUP: string, SHUTDOWN: string, SERVER_START: string, SERVER_LOG: string, SERVER_STOP: string}}}
 */
module.exports = {
  ATTRIBUTE_TYPE: {
    STRING: 'string'
