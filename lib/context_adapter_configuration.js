...
(function() {
  ...
  module.exports = {
    ...
    OPERATION_TYPE_PREFIX: 'OPER_CA_',
    TRANSACTION_ID: {
      NOT_AVAILABLE: 'NA'
    },
    OPERATION_TYPE: {
      NOT_AVAILABLE: 'NA',
      SHUTDOWN: 'OPER_CA_SHUTDOWN',
      SERVER_START: 'OPER_CA_SERVER_START',
      SERVER_LOG: 'OPER_CA_SERVER_LOG',
      SERVER_STOP: 'OPER_CA_SERVER_STOP'
    }
  };
  ...
  } else if (config.logging && config.logging.toConsole) {
  ...
  } else if (config.logging && config.logging.toFile) {
  ...
  } else if (config.logging && !isNaN(config.logging.maxFileSize)) {
  ...
  module.exports.LOG_FILE_NAME = ENV.LOG_FILE_NAME ||
    (config.logging && config.logging.fileName) || 'context_adapter.log';
