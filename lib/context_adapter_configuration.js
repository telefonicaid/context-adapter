 ...
 * CA_OPERATION_ACTION_ATTR_NAME: string, CA_INTERACTION_TYPE_ATTR_NAME: string, INTERACTION_TYPES:
 * {SYNCHRONOUS: string, ASYNCHRONOUS: string}, CA_OPERATION_EXTRA_ATTR_NAME: string,
